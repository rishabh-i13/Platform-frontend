      ...
      <div className=" px-3 lg:p-10">
        {
          blogs.map((blog, index) => (
            <div key={index} className="flex mb-5 gap-5 bg-gray-100 border-gray-400 border p-4 my-10 rounded-md flex-col md:flex-row">
              ...
              <div className="flex-col">
                ...
                <h3 className="text-right py-2 text-gray-600"> {blog.author}, {blog.date} </h3>
